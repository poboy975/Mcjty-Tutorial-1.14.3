...
import static com.poboy975.mcjtytutorial.blocks.ModBlocks.FIRSTBLOCK_CONTAINER;
...
public class FirstBlockContainer extends Container {
    ...
    public FirstBlockContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        ...
        tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h -> {
            addSlot(new SlotItemHandler(h, 0, 64, 24)); // input slot position
        });
        layoutPlayerInventorySlots(10, 70); // top left coords of start of player inventory
